 ...
 * @package  WordPress
 * @subpackage  Timber
 * Template Name: Location Event Template
 * @since    Timber 0.1
 */
...
$context['link'] = do_shortcode( '[ESPRESSO_TICKET_SELECTOR event_id="'.$post->ID.'"]' );
...
if ( post_password_required( $post->ID ) ) {
	...
	Timber::render( array( 'single-event-custom.twig' ), $context );
}
