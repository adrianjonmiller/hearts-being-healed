						...
						<?php  foreach ( $event_dashboard_columns as $key => $column ) : ?>
							<td class="<?php echo esc_attr( $key ); ?>">
								...
								<?php elseif ('event_start_date' === $key ) : 
											 $timestamp = strtotime(get_event_start_date($event)); echo date("F j, Y, g:i a",$timestamp); 
								?>
								<?php elseif ('event_end_date' === $key ) : 
											 $timestamp = strtotime(get_event_end_date($event)); echo date("F j, Y, g:i a",$timestamp); 
								?>
